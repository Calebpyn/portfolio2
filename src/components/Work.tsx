    ...
    <div className="h-screen w-full md:w-4/5 flex flex-col justify-around items-center" id='work'>
        ...
        <div className="w-4/5 shadow-2xl rounded-lg p-9" style={{backgroundImage: `url(${bgWork})`}}>
            ...
            <div className='mt-9'>
                ...
                <div className='backdrop-blur-md p-5 rounded-3xl group hover:cursor-pointer'>
                    ...
                    <div className='w-full h-0 opacity-0 transitions group-hover:h-[40vh] md:group-hover:h-[45vh] group-hover:opacity-100 group-hover:mt-5 text-white flex flex-col justify-between'>
                ...
                <div className='backdrop-blur-md p-5 rounded-3xl my-9 group hover:cursor-pointer'>
                    <div className='text-white flex flex-col text-lg'>
                    ...
                    <div className='w-full h-0 opacity-0 transitions group-hover:h-[40vh] md:group-hover:h-[49vh] group-hover:opacity-100 group-hover:mt-5 text-white flex flex-col justify-between'>
                ...
                <div className='backdrop-blur-md p-5 rounded-3xl group hover:cursor-pointer'>
                    ...
                    <div className='w-full h-0 opacity-0 transitions group-hover:h-[47vh] md:group-hover:h-[48vh] group-hover:opacity-100 group-hover:mt-5 text-white flex flex-col justify-between'>
